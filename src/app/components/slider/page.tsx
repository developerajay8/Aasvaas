...
const slides = [
  {
    ...
    click: ["Explore More"],
    image: "/assets/Ask Question First.mp4", // Replace with actual image path
  },
  ...
  },
  {
    ...
    click: ["Download"],
    image: "/assets/Mobile App Animation.mp4",
  },
];
  ...
  return (
    <div className="w-full overflow-hidden bg-[#E6E6E6] sm:hidden block">
      ...
      >
        ...
        muted
        playsInline
        className="rounded-[8px] border border-1
         border-[#15587D]"
      />
            ...
            <div className="max-w-[530px]">
              ...
              <button className="py-[15px] mt-[32px] cursor-pointer rounded-[6px] text-[16px] font-bold bg-[#2D9CDB] text-[#ffffff] px-[20px]">
                {slide.click}
              </button>
            </div>
          </div>
